...
const LOCAL_ICONS = [
  ...
  ["instagram", "instagram", "productivity"],
  ["facebook", "facebook", "productivity"],
  ["googleanalytics", "googleanalytics", "productivity"],
  ["googletagmanager", "googletagmanager", "productivity"],
  ["figma", "figma", "design"],
